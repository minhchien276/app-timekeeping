              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    buildItem(
                      title: 'Hồ sơ của bạn',
                      subtitle: 'Xem chi tiết hồ sơ của bạn',
                      icon: AppIcon.profile,
                      onTap: () => context.pushNamed(
                          AppRoute.profileDetail.name,
                          extra: controller.employee),
                    ),
                    const Divider(height: 0, thickness: 1),
                    // buildItem(
                    ...
                    buildItem(
                      ...
                      icon: AppIcon.book,
                      onTap: () => context.pushNamed(
                        AppRoute.testClientExams.name,
                      ),
                    ),
                    // const Divider(height: 0, thickness: 1),
                    // buildItem(
                    //   title: 'Giao việc',
                    //   subtitle: 'Các team tạo nhóm giao việc',
                    //   icon: AppIcon.news,
                    //   onTap: () => context.pushNamed(
                    //     AppRoute.work.name,
                    //   ),
